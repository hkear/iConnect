...
pub const WIN_SERVICE_WORK_DIR_REG_KEY: &str = "SOFTWARE\\iConnect\\Service\\WorkDir";

pub const ICONNECT_VERSION: &str = git_version::git_version!(
...
pub const EASYTIER_VERSION: &str = ICONNECT_VERSION;
