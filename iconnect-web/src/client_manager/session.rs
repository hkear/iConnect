...
impl WebServerService for SessionRpcService {
    ...
    async fn get_feature(
        &self,
        _: BaseController,
        _: iconnectd::proto::web::GetFeatureRequest,
    ) -> rpc_types::error::Result<iconnectd::proto::web::GetFeatureResponse> {
        Ok(iconnectd::proto::web::GetFeatureResponse {
            support_encryption: iconnectd::web_client::security::web_secure_tunnel_supported(),
        })
    }
}
...
mod tests {
    ...
    async fn sync_running_config_sources_updates_enabled_config_source_from_runtime() {
        ...
        Session::sync_running_config_sources(
            ...
            machine_id,
            &local_configs,
            &[iconnectd::proto::api::manage::NetworkMeta {
